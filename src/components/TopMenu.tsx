...
const getTotalCount = (cart: ShoppingCart): number => {
  let items = 0;
    ...
    <div className="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
      ...
      <div className="px-6 flex items-center justify-between space-x-4">
        ...
        <div className="flex space-x-2">
          ...
          <Link href={"/dashboard/cart"} className="p-2 h-10 flex items-center justify-center rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200">
            {
